...
**현재 단계: G002 — 첫 손님과 첫 매출 구현.** 카운터에서 영업을 시작하면 고객이 빈자리를 찾아 이용하고 결제합니다. 저장은 아직 없으며 새로고침하면 초기화됩니다. 저장소는 [dm-choo/pc-cafe-simulator](https://github.com/dm-choo/pc-cafe-simulator)입니다. 등록·검증 상태와 다음 작업은 [현재 상태](docs/production/status.md)에 기록합니다.
...
현재 공간과 인물은 코드로 만든 임시 형상·재질입니다. 대표 현실풍 GLB 자산은 G003에서 같은 장면에 연결합니다.
