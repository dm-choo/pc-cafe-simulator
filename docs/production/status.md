...
- 목재·콘크리트·벽에 Poly Haven CC0 1K PBR 9장(총 5,961,103 bytes), 공유 환경 반사, 실내 조명 조정. 런타임 외부 CDN 없음.
- 로컬 규칙 18개, lint·타입 검사·빌드 통과. 브라우저 5개와 새 화면 검토·공개 배포는 이번 변경의 CI 결과를 기다립니다.
