...
기준일: 2026-09-07. **G001 PR #11 main 통합 완료. G002 첫 손님·첫 매출 구현 후 브라우저 검증 중입니다.**
...
- G002의 규칙·브라우저 검증 결과는 후속 커밋에 기록합니다. G001의 성공 기록을 G002 성공으로 사용하지 않습니다.

## 다음 행동

G002의 FIRST-SALE과 기존 BASIC-12를 함께 검증하고 화면·상태를 확인합니다. 이후 G003 대표 좌석·인물 자세·조명 개선으로 이어집니다. 공개 Pages 배포와 저장은 아직 없습니다.
