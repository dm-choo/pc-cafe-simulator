...
export default defineConfig({
  ...
  use: { baseURL: 'http://127.0.0.1:4173/pc-cafe-simulator/', viewport: { width: 1440, height: 900 },
  ...
  webServer: { command: 'npm run preview -- --port 4173 --strictPort', url: 'http://127.0.0.1:4173/pc-cafe-simulator/', reuseExistingServer: !process.env.CI },
});
